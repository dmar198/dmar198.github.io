...
document.write("<center><div id=\"title-div\" style=\"max-width:600px;margin-auto;height:40px;line-height:40px;font-size:40px;background-color:white;\">");
document.write("<center><span style=\"background-color:white;\">Gnat Politics</span></center></div></center>");
document.write("<div id=\"subtitle-div\" style=\"max-width:600px;margin:auto;height:40px;line-height:40px;background-color:white;\">");
document.write("<center><span style=\"background-color:white;\">Hyping the Greatest Nation of All Time</span></center></div>");
